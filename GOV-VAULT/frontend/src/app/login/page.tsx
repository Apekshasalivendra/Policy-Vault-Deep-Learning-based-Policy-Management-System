...
export default function LoginPage() {
    ...
    // Always show the login form — no auto-redirect based on existing session.
    // If already authenticated the user will be redirected after a fresh login.
    ...
    const handleSubmit = async (e: FormEvent) => {
        ...
        try {
            ...
            const token = sessionStorage.getItem('govvault_token');
            if (token) {
