...
const quickLinks = [
    {
        ...
        desc: 'Review and approve pending family registrations',
    ...
    },
    {
        ...
        desc: 'Review AI-recommended welfare scheme claims',
    ...
    },
    {
        ...
        desc: 'Review LIC and insurance policy claim requests',
        color: 'bg-violet-50 hover:bg-violet-100 border-violet-200',
    },
    {
        href: '/admin/orphans',
        icon: <UserCheck className="h-6 w-6 text-emerald-600" />,
        label: 'Orphan Trust Funds',
        desc: 'Manage orphan policy claims and school fees',
